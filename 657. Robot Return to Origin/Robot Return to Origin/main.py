...
# Example 1:
#
# Input: "UD" Output: true Explanation: The robot moves up once, and then down once. All moves have the same
# magnitude, so it ended up at the origin where it started. Therefore, we return true.

# Example 2:
#
# Input: "LL" Output: false Explanation: The robot moves left twice. It ends up two "moves" to the left of the
...
if __name__ == '__main__':
    str = 'LL'
    solution = Solution()
    isCircle = solution.judgeCircle(str)

    print 'is circle: %d' % isCircle
